class SyncMessageRequestEntity {
  int? msgid;
  SyncMessageRequestEntity({this.msgid});

  Map<String, dynamic> toJson() => {"msgid": msgid};
}
...
class CallTokenRequestEntity {
  ...
  CallTokenRequestEntity({this.call_token, this.to_token});
...
class ChatRequestEntity {
  ...
  ChatRequestEntity({this.content, this.type, this.to_token});
